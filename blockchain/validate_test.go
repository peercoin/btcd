...
var Block100000OLD = wire.MsgBlock{
...
var Block100000PoS = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version: 1,
		PrevBlock: chainhash.Hash([32]byte{
			0x3f, 0xee, 0xe1, 0x6b, 0x24, 0x76, 0x67, 0x7e,
			0x9a, 0xe9, 0xa0, 0xc3, 0xc7, 0x12, 0x63, 0xda,
			0x64, 0x4a, 0x75, 0xe2, 0xde, 0x68, 0x8c, 0xeb,
			0x70, 0x42, 0x6a, 0xe1, 0x1d, 0x5e, 0xfd, 0x27,
		}),
		MerkleRoot: chainhash.Hash([32]byte{
			0x3a, 0x38, 0xa8, 0xea, 0x7b, 0x4d, 0x7a, 0x4d,
			0x7a, 0xe0, 0x58, 0x6c, 0xed, 0x59, 0xe8, 0xdc,
			0x3d, 0x3f, 0x6c, 0x00, 0x45, 0x65, 0xc5, 0x25,
			0x12, 0x16, 0xd5, 0x8e, 0xfd, 0x74, 0x28, 0x7d,
		}),
		Timestamp: time.Unix(1394106567, 0),
		Bits:      0x1c193250,
		Nonce:     0x00,
	},
	Transactions: []*wire.MsgTx{
			...
			TxIn: []*wire.TxIn{
				{
					...
					SignatureScript: []byte{
						0x04, 0xc7, 0x60, 0x18, 0x53, 0x02, 0x2a, 0x01,
		...
		}, // tx 0
		{
			...
			TxIn: []*wire.TxIn{
				{
					PreviousOutPoint: wire.OutPoint{
						Hash: chainhash.Hash{
							0x0e, 0x37, 0xf1, 0x7d, 0x64, 0xbe, 0x71, 0xd6,
							0x99, 0x29, 0x6d, 0x5a, 0x76, 0xbe, 0xfa, 0x74,
							0x72, 0x3a, 0xd3, 0x23, 0x32, 0x18, 0xab, 0x89,
							0x10, 0x3c, 0x15, 0x91, 0x89, 0xfc, 0xef, 0x5a,
						},
						Index: 2,
					},
					SignatureScript: []byte{
						0x48, 0x30, 0x45, 0x02, 0x20, 0x5e, 0xa7, 0xfc,
						0x1a, 0x68, 0x29, 0x4e, 0x3a, 0xcc, 0x6d, 0xff,
						0xd1, 0x63, 0x6e, 0x99, 0xb2, 0xbd, 0xf1, 0x1b,
						0xb8, 0x91, 0xd9, 0x31, 0x5e, 0xaa, 0x99, 0xc4,
						0x9d, 0x4d, 0x3b, 0x9e, 0x06, 0x02, 0x21, 0x00,
						0x98, 0x88, 0x8f, 0xad, 0xb8, 0x5b, 0x54, 0xbc,
						0xd8, 0x75, 0x8d, 0xb4, 0x28, 0xf2, 0x72, 0x3f,
						0x8d, 0x5b, 0xbf, 0x5e, 0x4c, 0x79, 0x95, 0x26,
						0x98, 0x2e, 0x59, 0xfa, 0xe3, 0xd8, 0x6f, 0x16,
						0x01,
					},
					Sequence: 0xffffffff,
				},
			...
			TxOut: []*wire.TxOut{
				...
				},
				{
					Value: 0x23619E0,
					PkScript: []byte{
						0x21, 0x03, 0x99, 0x79, 0x2c, 0x3b, 0x9c, 0x66,
						0x12, 0x4b, 0xd0, 0xc9, 0x52, 0x7e, 0xce, 0xda,
						0x6b, 0xd3, 0xb2, 0xcf, 0x73, 0xa7, 0xe4, 0x1f,
						0xfd, 0x8c, 0xe5, 0xa4, 0x43, 0xb6, 0xe9, 0x1d,
						0x7c, 0x1, 0xac,
					},
				},
				{
		...
		{
			Version:   1,
			Timestamp: time.Unix(1394105142, 0),
			TxIn: []*wire.TxIn{
				{
					PreviousOutPoint: wire.OutPoint{
						Hash: chainhash.Hash{
							0x1e, 0xfa, 0x54, 0x44, 0x97, 0x4d, 0x8b, 0xf2,
							0xd9, 0x7b, 0xb9, 0x0d, 0xfb, 0x1c, 0xbf, 0x1f,
							0xea, 0x03, 0x36, 0x4d, 0xac, 0x5c, 0x4b, 0xa1,
							0x78, 0x49, 0x83, 0x21, 0xcd, 0x63, 0x86, 0x09,
						},
						Index: 0,
					},
					SignatureScript: []byte{
						0x48, 0x30, 0x45, 0x02, 0x20, 0x1b, 0x9a, 0xb0,
						0x6e, 0xe0, 0x71, 0x8b, 0x02, 0x9d, 0x8b, 0xa3,
						0x19, 0xe9, 0xa8, 0xc3, 0x72, 0x0b, 0x78, 0xe0,
						0xad, 0x51, 0x74, 0xfa, 0xee, 0x65, 0xba, 0xaa,
						0x4f, 0x68, 0x31, 0x9d, 0xa5, 0x02, 0x21, 0x00,
						0xb1, 0x19, 0xcf, 0xa4, 0x09, 0x27, 0xc4, 0xa8,
						0xe7, 0x90, 0x46, 0xd9, 0xc2, 0x51, 0xd1, 0x77,
						0x6e, 0xa5, 0x80, 0xd2, 0xf3, 0xd2, 0xfb, 0x47,
						0x88, 0x12, 0x83, 0x11, 0xb4, 0x2a, 0x47, 0x2a,
						0x01, 0x21, 0x02, 0x59, 0x35, 0x78, 0x80, 0x4a,
						0x55, 0x17, 0x1a, 0xdb, 0x32, 0x7e, 0xd4, 0x11,
						0xaf, 0x97, 0xf4, 0xd4, 0xd1, 0xda, 0xe2, 0x44,
						0x95, 0x79, 0xf8, 0xb9, 0xeb, 0xd1, 0x7a, 0xe4,
						0xbe, 0xe5, 0x42,
					},
					Sequence: 0xffffffff,
				},
			...
			TxOut: []*wire.TxOut{
				{
					Value: 0x1DBF90C,
					PkScript: []byte{
						0x76, 0xa9, 0x14, 0x5d, 0x3c, 0x63, 0xca, 0x13,
						0x24, 0xc9, 0x35, 0xab, 0x78, 0xb8, 0x22, 0xd7,
						0xd4, 0xd3, 0xa3, 0xc2, 0x6d, 0x89, 0xd2, 0x88,
						0xac,
					},
				},
				{
					Value: 0x2255100,
					PkScript: []byte{
						0x76, 0xa9, 0x14, 0x2e, 0xfc, 0x51, 0xc, 0x6b,
						0xc2, 0x55, 0xf0, 0xce, 0xdb, 0x64, 0xc8, 0xcf,
						0x1b, 0x9b, 0x49, 0xa5, 0xd5, 0xeb, 0x9f, 0x88,
						0xac,
					},
				},
			},
	...
	Signature: []byte{
		0x30, 0x45, 0x02, 0x21, 0x00, 0x96, 0x7b, 0x56,
		0xce, 0x3e, 0x91, 0xb1, 0xd5, 0x5c, 0x7b, 0x3c,
		0xdd, 0x2a, 0x35, 0xab, 0x77, 0x0b, 0xd0, 0xa1,
		0x0a, 0x60, 0x46, 0x95, 0xa7, 0x2c, 0x03, 0x1e,
		0x1f, 0x2a, 0x00, 0x40, 0xec, 0x02, 0x20, 0x18,
		0x73, 0xcc, 0x5b, 0x0d, 0x54, 0xdf, 0xd3, 0xdf,
		0xdf, 0x64, 0x21, 0xe0, 0x51, 0x9e, 0xf5, 0x80,
		0xa1, 0x32, 0xfe, 0xf2, 0xbc, 0xaf, 0x5d, 0x2c,
		0xc4, 0x97, 0xfa, 0xc8, 0xb3, 0x49, 0xc6,
	},
}