...
func upgradeDBPaths() error {
	...
	upgradeDBPathNet(filepath.Join(oldDbRoot, "ppcd.db"), "mainnet")
	upgradeDBPathNet(filepath.Join(oldDbRoot, "ppcd_testnet.db"), "testnet")
	upgradeDBPathNet(filepath.Join(oldDbRoot, "ppcd_regtest.db"), "regtest")
